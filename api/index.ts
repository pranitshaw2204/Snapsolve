...
// Main AI Generation Endpoint for Vercel Serverless Function
...
${Object.entries(inputs || {})
  ...
  .join("\n")}`;
    ...
    // 2. Server-side GEMINI_API_KEY from environment variables
    ...
    // 3. Fallback to user provided custom key in request body
